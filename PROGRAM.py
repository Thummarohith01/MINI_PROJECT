...
class MiniProject:
    ...
    def ResumeParser(self, job_description, resume):
        try:
            if job_description and resume:
                ...
                [(relvance_score),[missing_skills],[missing_keywords],[recommendations]]
                """
    ...
    def create_gauge_chart(self):
        ...
        labels = ['not Relevant', 'some what Relevant', 'Relvent']
...
class CVAnalysisDashboard:
    ...
    def _run_display(self):
        # Accuracy Score
        accuracy = self.mini_project.RelvanceScore()
